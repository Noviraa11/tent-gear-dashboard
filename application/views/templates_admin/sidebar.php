      ...
      <div class="main-sidebar">
        <aside id="sidebar-wrapper">
          <div class="sidebar-brand">
            <a href="<?= base_url('admin/dashboard'); ?>">Tent Gear Adventure</a>
          </div>
          <div class="sidebar-brand sidebar-brand-sm">
            <a href="index.html">TGA</a>
          </div>
          <ul class="sidebar-menu">
            <li><a class="nav-link" href="<?= base_url('admin/dashboard'); ?>"><i class="fas fa-tachometer-alt"></i> <span>Dashboard</span></a></li>

            <li><a class="nav-link" href="<?= base_url('admin/data_tenda'); ?>"><i class="fas fa-car"></i> <span>Data Tenda</span></a></li>
