      ...
      <div class="container mt-5">
        <div class="row">
          <div class="col-12 col-sm-10 offset-sm-1 col-md-8 offset-md-2 col-lg-8 offset-lg-2 col-xl-8 offset-xl-2">
            ...
            <img src="<?= base_url('assets/assets_shop') ?>/images/logo_amikom_full_color.png" alt="logo" width="130" class="shadow-light rounded-circle">
            </div>
            ...
            Copyright &copy; Teant Gear Adventure 2024
            </div>
          </div>
        </div>
      </div>
