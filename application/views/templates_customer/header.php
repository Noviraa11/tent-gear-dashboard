...
<html lang="en">
  ...
  <head>
    ...
    <title>Tent Gear | Adventure</title>
  ...
  <body>
    ...
    <header class="">
      <nav class="navbar navbar-expand-lg">
        <div class="container">
          <img class="navbar-brand" src="<?= base_url('assets/assets_shop') ?>/images/logo.png" alt="logonav">
          ...
          <div class="collapse navbar-collapse" id="navbarResponsive">
            <ul class="navbar-nav ml-auto">
              ...
              <li class="nav-item">
                <a class="nav-link" href="<?= base_url('customer/data_tenda') ?>">Tenda</a>
              </li>
              <li class="nav-item">
